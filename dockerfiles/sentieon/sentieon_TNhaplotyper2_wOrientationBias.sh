...
# Generate OrientationBias metrics.
...
# Input BAM files
shift 4 # $@ store all the input files
...
command+=" --algo TNhaplotyper2 --tumor_sample $sample_name output.vcf.gz"
