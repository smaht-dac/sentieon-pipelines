...
sentieon driver -r $fasta -t $nt $input_files --read_filter 'QualCalFilter,table=recal_data.table,keep_oq=true,indel=false' --algo ReadWriter recalibrated.bam || exit 1
